...
1. **v8.1 Platform Setup Regions — Phases 810-816** — 🔄 Active. Phases 810–813 executed (2026-07-11): ring extension + screen shell, AI Engine screen, connector credential backend, connectors screen. 15 commits. Phases 814–816 remain: Reasoner, DG API Docs, Integration & Deploy (plans written). See [[sessions/2026-07-11 v8.1 milestone init and phases 810-813|session]] and [[decisions/Milestone-derived phase numbering convention|phase numbering decision]].
...
- **v8.1 milestone init + phases 810–813 execution** — 2026-07-11. 4 новых setup региона на landing ring (AI Engine, Connectors, Reasoner, DG API Docs). Ring extension + skeletons (810), AI Engine screen (811), connector credential backend — 14 connectors, dgc_ tokens, heartbeat (812), Connectors screen (813). 15 коммитов. Phases 814–816 готовы к исполнению. See [[sessions/2026-07-11 v8.1 milestone init and phases 810-813|session]].
