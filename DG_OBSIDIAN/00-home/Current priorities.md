...
1. **v7.0 Phase 14 (Graph Schema v4 Propagation)** — next after Phase 13. Propagate V7 ontology changes across `cypher_template.txt`, `dataset_schema.json`, n8n workflow prompts, NeoVis `config.template.js`, and data-service Cypher queries. Start with `/gsd-discuss-phase 14`. See [[sessions/2026-07-03 Phase 13 execution and Nyquist validation|Phase 13 execution session]].
