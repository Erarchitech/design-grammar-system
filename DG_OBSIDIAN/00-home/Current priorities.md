...
1. **v7.0 Phase 13 (Ontology V7 and Contract Investigation)** — planned, ready to execute. Next: `/gsd-execute-phase 13`. 4 plans across 3 waves: 13-01 (investigation note + rename table) → 13-02 (`apply_v7_rename.py` + V7 owl) → {13-03 (port↔IRI map) ∥ 13-04 (extension facades + docs)}. See [[sessions/2026-07-03 Phase 13 planning - 4 plans across 3 waves|planning session]], [[sessions/2026-07-03 Phase 13 discuss - ValidGraph and per-object ValidStatus|discuss session]], [[decisions/DesignState persists to ValidGraph not Metagraph|ValidGraph decision]], [[decisions/Run ValidStatus is a per-object boolean array|ValidStatus decision]].
