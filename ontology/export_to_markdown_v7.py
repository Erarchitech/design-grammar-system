"""
Export DesignGrammar-V7.owl to a NotebookLM-friendly markdown file.

Produces ontology/DesignGrammar-V7.md — a human-readable, well-structured
...
def main():
    ...
    owl_path = project_root / "ontology" / "DesignGrammar-V7.owl"
    md_path = project_root / "ontology" / "DesignGrammar-V7.md"
    ...
    out.append(f"**Source:** `[DesignGrammar-V7.owl](DesignGrammar-V7.owl)`  ")
    ...
    out.append("")
    out.append("The DG ontology partitions its content into a Core band plus five logical layers, each tagged with a `dg:graph` annotation on every class. All four layers persist into a single Neo4j database, isolated by the `dg:project` annotation.")
    out.append("")
    ...
    for prefix in ["dg", "dgm", "dgv", "dgs", "dgc"]:
    ...
    out.append("---")
    out.append("")
    out.append(f"*Auto-generated from `[DesignGrammar-V7.owl](DesignGrammar-V7.owl)` v{version_info}. Counts: "
