"""
Export DesignGrammar-V6.owl to a NotebookLM-friendly markdown file.

Produces ontology/DesignGrammar-V6.md — a human-readable, well-structured
...
def main():
    ...
    owl_path = project_root / "ontology" / "DesignGrammar-V6.owl"
    md_path = project_root / "ontology" / "DesignGrammar-V6.md"
    ...
    out.append(f"**Source:** `[DesignGrammar-V6.owl](DesignGrammar-V6.owl)`  ")
    ...
    out.append("---")
    out.append("")
    out.append(f"*Auto-generated from `[DesignGrammar-V6.owl](DesignGrammar-V6.owl)` v{version_info}. Counts: "
