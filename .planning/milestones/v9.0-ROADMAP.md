...
**Status:** Paused (Phase 28 executed 2026-07-06, parked; resume after v8.0 follow-ups)
...
> **Isolation contract:** This document and `v9.0-REQUIREMENTS.md` are the primary v9.0 artifacts. Nothing here modifies `.planning/phases/`, STATE.md, or shipped milestones. Phase numbers are **global (28–40)**; at activation the phase directories move from `milestones/v9.0-phases/` into `.planning/phases/` unchanged.
...
**Success Criteria:** met — see `v9.0-phases/28-cloud-llm-connector/28-VERIFICATION.md`
...
*Roadmap defined: 2026-07-03; restructured 2026-07-08 — Computgraph serialization pipeline (Phases 32–37) elaborated from the Frame worked example; script generation/editing/consulting planned as v10.0*
*Renumbered 2026-07-08: milestone-local 1–13 → global 28–40 (continuing from v8.0 Phase 27)*
