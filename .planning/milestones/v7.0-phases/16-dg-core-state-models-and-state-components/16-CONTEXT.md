...
- `.planning/milestones/v7.0-phases/13-ontology-v7-and-contract-investigation/13-CONTEXT.md` — D-01 through D-11: DesignState layer placement (ValidGraph), MerGE by StateId+project, no-orphan invariant, ValidStatus per-ObjState Boolean array, PS_ prefix, V7 ontology names
</canonical_refs>
