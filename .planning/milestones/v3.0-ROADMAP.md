...
- [x] 07-01-PLAN.md — VariableKind enum + VariableTypeInferrer priority-chain classifier (unit-tested)
- [x] 07-02-PLAN.md — DefState/ObjectState/ObjectInstance C# models + DesignStateIdGenerator (DS_/OS_/OI_)
