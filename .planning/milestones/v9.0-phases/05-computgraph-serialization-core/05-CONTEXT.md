# Phase 5 Context: Computgraph Serialization Core
...
2. **Parser in DG.Core**: `Parsing/CanvasAnnotationParser.cs`. Grammar (case-sensitive prefixes, regex-based; full grammar in `05-RESEARCH.md`):
   ...
   - **Anything non-conforming → untagged set.** The parser never guesses; guessing is Phase 8's job (LLM) with human confirmation.
...
- Research: [05-RESEARCH.md](05-RESEARCH.md) — protocol/ontology/fixture reference, cgContextJson v1 draft schema
