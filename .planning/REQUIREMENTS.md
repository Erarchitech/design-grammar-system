...
- [x] **GHVL-03**: VALIDATOR implements the new contract — inputs Rule, DesignState, SendValid, Run; outputs ValidStatus, RuleName, RuleDescription, SendStatus — keeping non-overlapping extras (DataServiceUrl input; Report, FailingBindings, ValidationRunId, ModelViewerUrl outputs)
...
- [x] **GHVL-05**: The publish path persists a Run with ValidStatus/SendStatus and the 3-part state payload; VALIDATION GRAPH reads it back intact
