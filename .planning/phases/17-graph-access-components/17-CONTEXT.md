...
- `.planning/phases/13-ontology-v7-and-contract-investigation/13-CONTEXT.md` — D-01 through D-11: DesignState layer placement (ValidGraph), MERGE by StateId+project, no-orphan invariant, ValidStatus per-ObjState Boolean array, VALIDATION GRAPH new GUID
...
- `.planning/phases/16-dg-core-state-models-and-state-components/16-CONTEXT.md` — D-01/D-02 (DesignState composition = independent bags), D-04 (deterministic StateId), DesignState model definition
</canonical_refs>
