...
- `.planning/phases/13-ontology-v7-and-contract-investigation/13-CONTEXT.md` — decisions D-01..D-11 that flow directly into this phase (Run.ValidStatus per-object list, no-orphan invariant, DesignState→ValidGraph).
